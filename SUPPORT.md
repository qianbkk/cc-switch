...
> 由个人维护，**不承诺响应时效**。
>
> - **魔改功能的问题**（统一网关、Live 配置保护、Codex auth 同步、魔改总开关）
>   → 在[本仓库开 Issue](https://github.com/qianbkk/cc-switch/issues)
> - **原版就有的问题 / 一般用法** → 请去[上游仓库](https://github.com/farion1231/cc-switch/issues)，
>   那里用户多、维护者在线
> - **怀疑是魔改导致的** → 先在「设置 → 通用 → 魔改功能」里关掉总开关，
>   应用会回到原版行为；如果问题消失，说明确实是魔改引入的，请报到本仓库
>
> 下面是继承自上游的原始求助指引，其中的链接指向上游仓库。
